...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "mikejcranwill-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/mike_org"
  #   chef.validation_client_name = "mike_org-validator"
  #   chef.validation_key_path = ".chef/mike_org-validator.pem"
  # end
end
